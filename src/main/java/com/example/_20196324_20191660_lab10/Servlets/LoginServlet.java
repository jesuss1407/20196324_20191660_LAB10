...
import com.example._20196324_20191660_lab10.Beans.EstudianteBean;
import com.example._20196324_20191660_lab10.Daos.EstudianteDao;
...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action){
            case "login":
                EstudianteBean estudiante = (EstudianteBean) session.getAttribute("uduarioLogueado");
